...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    if (shouldShowFFTAnalysis)
    {
        ...
        g.setColour(Colour(215u, 201u, 134u)); //Light Purple
...
void PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
    ...
    //if we can pull a buffer to generate a path
    ...
    //while there are paths to be pulled, pull as many as you can
...
void SimpleEQAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    String title{ "Willem Stewart (source: PFM::C++ FOR MUSICIANS)" };
    g.setFont(30);
    ...
    curve.quadraticTo(curvePos.getX() - cornerSize, curvePos.getY(), curvePos.getX() - cornerSize, curvePos.getY() - 16);
    curvePos = curve.getCurrentPosition();
    curve.quadraticTo(curvePos.getX(), 2, curvePos.getX() - cornerSize, 2);
